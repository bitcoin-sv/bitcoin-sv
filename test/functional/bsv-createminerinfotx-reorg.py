...
class AllKeys:
    last_seed_number = 1
    def __init__(self):
        self.minerIdKeys = MinerIdKeys("0{}".format(self.last_seed_number + 1))
        self.revocationKeys = MinerIdKeys("0{}".format(self.last_seed_number + 2))
        self.prev_minerIdKeys = MinerIdKeys("0{}".format(self.last_seed_number + 3))
        self.prev_revocationKeys = MinerIdKeys("0{}".format(self.last_seed_number + 4))
        self.compromisedKeys = MinerIdKeys("0{}".format(self.last_seed_number + 5))
        self.fundingKeys = MinerIdKeys("0{}".format(self.last_seed_number + 6))
        self.last_seed_number = self.last_seed_number + 6 + 1
