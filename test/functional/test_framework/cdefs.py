...
SAFE_MODE_DEFAULT_MIN_VALID_FORK_LENGTH = _extractValidationValue('SAFE_MODE_DEFAULT_MIN_VALID_FORK_LENGTH')
SAFE_MODE_DEFAULT_MAX_VALID_FORK_DISTANCE = _extractValidationValue('SAFE_MODE_DEFAULT_MAX_VALID_FORK_DISTANCE')
...
if __name__ == "__main__":
    ...
    print("SAFE_MODE_DEFAULT_MIN_VALID_FORK_LENGTH = %d" % SAFE_MODE_DEFAULT_MIN_VALID_FORK_LENGTH)
    print("SAFE_MODE_DEFAULT_MAX_VALID_FORK_DISTANCE = %d" % SAFE_MODE_DEFAULT_MAX_VALID_FORK_DISTANCE)
