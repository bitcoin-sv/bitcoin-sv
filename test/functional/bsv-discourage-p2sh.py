...
"""
Check -acceptp2sh_ashashpuzzle=0 flag which rejects transactions with P2SH in output after Genesis.
Check -acceptp2sh_ashashpuzzle=1 flag which treats transactions with P2SH as non-standard. 
"""
