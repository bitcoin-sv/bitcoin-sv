...
class MinimalEncodingTestCase(ChronicleHeightBasedSimpleTestsCase):
    ...
    TESTS = [
        ...
        SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
                             "PRE_CHRONICLE", CScript([OP_PUSHDATA1, CScriptOp(0)]),
        ...
        SimpleTestDefinition(None, CScript([OP_1ADD, OP_DROP, OP_TRUE]),
                             "PRE_CHRONICLE", CScript([CScriptOp(2), CScriptOp(0), CScriptOp(0)]),
        ...
        SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
                             "CHRONICLE_PRE_GRACE", CScript([OP_PUSHDATA1, CScriptOp(0)]),
                             p2p_reject_reason=b'non-mandatory-script-verify-flag (Data push larger than necessary)'),
        SimpleTestDefinition(None, CScript([OP_1ADD, OP_DROP, OP_TRUE]),
                             "CHRONICLE_PRE_GRACE", CScript([CScriptOp(2), CScriptOp(0), CScriptOp(0)]),
                             p2p_reject_reason=b'non-mandatory-script-verify-flag (Non-minimally encoded script number)'),
        ...
        #SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_GRACE_BEGIN", CScript([OP_PUSHDATA1, CScriptOp(0)]),
        #                     p2p_reject_reason=b'flexible-non-mandatory-script-verify-flag (Data push larger than necessary)'),
        #SimpleTestDefinition(None, CScript([OP_1ADD, OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_GRACE_BEGIN", CScript([CScriptOp(2), CScriptOp(0), CScriptOp(0)]),
        ...
        #SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_PRE_ACTIVATION", CScript([OP_PUSHDATA1, CScriptOp(0)])),
        #SimpleTestDefinition(None, CScript([OP_1ADD, OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_PRE_ACTIVATION", CScript([CScriptOp(2), CScriptOp(0), CScriptOp(0)])),

        # Chronicle activation height
        #SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_ACTIVATION", CScript([OP_0])),
        #SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_ACTIVATION", CScript([OP_PUSHDATA1, CScriptOp(0)])),
        #SimpleTestDefinition(None, CScript([OP_1ADD, OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_ACTIVATION", CScript([CScriptOp(2), CScriptOp(0), CScriptOp(0)])),

        # Block after Chronicle activation height
        #SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_POST_ACTIVATION", CScript([OP_0])),
        #SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_POST_ACTIVATION", CScript([OP_PUSHDATA1, CScriptOp(0)])),
        #SimpleTestDefinition(None, CScript([OP_1ADD, OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_POST_ACTIVATION", CScript([CScriptOp(2), CScriptOp(0), CScriptOp(0)])),

        # End of chronicle grace period
        #SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_GRACE_END", CScript([OP_0])),
        #SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_GRACE_END", CScript([OP_PUSHDATA1, CScriptOp(0)])),
        #SimpleTestDefinition(None, CScript([OP_1ADD, OP_DROP, OP_TRUE]),
        #                     "CHRONICLE_GRACE_END", CScript([CScriptOp(2), CScriptOp(0), CScriptOp(0)])),

        # After Chronicle
        #SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
        #                     "POST_CHRONICLE", CScript([OP_0])),
        #SimpleTestDefinition(None, CScript([OP_DROP, OP_TRUE]),
        #                     "POST_CHRONICLE", CScript([OP_PUSHDATA1, CScriptOp(0)])),
        #SimpleTestDefinition(None, CScript([OP_1ADD, OP_DROP, OP_TRUE]),
        #                     "POST_CHRONICLE", CScript([CScriptOp(2), CScriptOp(0), CScriptOp(0)])),
    ]
