...
Scenario:
1. Generate two branches. Main branch and alternative branch that has more than SAFE_MODE_DEFAULT_MIN_VALID_FORK_LENGTH blocks.
...
from test_framework.cdefs import SAFE_MODE_DEFAULT_MIN_VALID_FORK_LENGTH, SAFE_MODE_DEFAULT_MAX_VALID_FORK_DISTANCE
...
class TriggerSafeModeByValidChain(BitcoinTestFramework):
    ...
    def run_test(self):
        with self.run_node_with_connections("Preparation", 0, None, 2) as (conn1, conn2):
            ...
            for _ in range(SAFE_MODE_DEFAULT_MAX_VALID_FORK_DISTANCE):
            ...
            for _ in range(SAFE_MODE_DEFAULT_MIN_VALID_FORK_LENGTH + 1):
            ...
            send_by_headers(conn1, branch_1_blocks[:SAFE_MODE_DEFAULT_MIN_VALID_FORK_LENGTH + 2], do_send_blocks=True)
            ...
            wait_for_tip(conn1, branch_1_blocks[SAFE_MODE_DEFAULT_MIN_VALID_FORK_LENGTH + 1].hash)
