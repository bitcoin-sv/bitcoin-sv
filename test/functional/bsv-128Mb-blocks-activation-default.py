...
"""
Test that the new default 128Mb blocks activates correctly without the use
of the excessiveblocksize parameter.

In short; if the user doesn't override things via the excessiveblocksize
paramaeter then after the Nov 15th HF date the default max block size should
become 128Mb.
"""
