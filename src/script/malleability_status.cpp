...
static_assert(!is_null_dummy(ms_unclean_stack));
static_assert(!is_minimal_if(ms_unclean_stack));
...
static_assert(!is_null_dummy(ms_min_push));
static_assert(!is_minimal_if(ms_min_push));
...
static_assert(!is_null_dummy(ms_min_scriptnum));
static_assert(!is_minimal_if(ms_min_scriptnum));
...
static_assert(!is_null_dummy(ms_high_s));
static_assert(!is_minimal_if(ms_high_s));
...
static_assert(!is_null_dummy(ms_non_push_data));
static_assert(!is_minimal_if(ms_non_push_data));
...
static_assert(!is_null_dummy(ms_null_fail));
static_assert(!is_minimal_if(ms_null_fail));
static_assert(!is_disallowed(ms_null_fail));

constexpr malleability::status ms_null_dummy{malleability::null_dummy};
static_assert(malleability::null_dummy == ms_null_dummy);
static_assert(is_malleable(ms_null_dummy));
static_assert(!is_unclean_stack(ms_null_dummy));
static_assert(!is_non_minimal_push(ms_null_dummy));
static_assert(!is_non_minimal_scriptnum(ms_null_dummy));
static_assert(!is_high_s(ms_null_dummy));
static_assert(!has_non_push_data(ms_null_dummy));
static_assert(!is_null_fail(ms_null_dummy));
static_assert(is_null_dummy(ms_null_dummy));
static_assert(!is_minimal_if(ms_null_dummy));
static_assert(!is_disallowed(ms_null_dummy));

constexpr malleability::status ms_minimal_if{malleability::minimal_if};
static_assert(malleability::minimal_if == ms_minimal_if);
static_assert(!is_malleable(ms_minimal_if));
static_assert(!is_unclean_stack(ms_minimal_if));
static_assert(!is_non_minimal_push(ms_minimal_if));
static_assert(!is_non_minimal_scriptnum(ms_minimal_if));
static_assert(!is_high_s(ms_minimal_if));
static_assert(!has_non_push_data(ms_minimal_if));
static_assert(!is_null_fail(ms_minimal_if));
static_assert(!is_null_dummy(ms_minimal_if));
static_assert(is_minimal_if(ms_minimal_if));
static_assert(!is_disallowed(ms_minimal_if));
...
static_assert(!is_null_dummy(ms_disallowed));
static_assert(!is_minimal_if(ms_disallowed));
...
static_assert(is_null_dummy(ms_all));
static_assert(is_disallowed(ms_all));

static_assert(malleability::status{0x8008} == []() constexpr
              {
