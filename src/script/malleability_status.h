...
namespace malleability
{
    ...
    constexpr static status non_minimal_encoding {0x02};
    constexpr static status high_s               {0x04};
    constexpr static status non_push_data        {0x08};
...
constexpr bool is_non_minimal_encoding(const malleability::status s)
{
    return s & malleability::non_minimal_encoding;
}
