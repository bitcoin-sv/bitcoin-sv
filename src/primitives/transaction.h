...
public:
    ...
    // Pre-Chronicle, the min & max standard transaction versions
    static constexpr int32_t PRE_CHRONICLE_MIN_STANDARD_VERSION = 1;
    static constexpr int32_t PRE_CHRONICLE_MAX_STANDARD_VERSION = 2;
