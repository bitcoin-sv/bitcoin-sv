...
constexpr int64_t int64_min{std::numeric_limits<int64_t>::min()+1};
...
namespace
{
    ...
    int64_t_test_data_type int64_t_test_data = 
    {
        ...
        {int64_min, {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}},
    ...
    bint_test_data_type bint_test_data = 
    {
        ...
        {bn_min64 - 1, {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80, 0x80}},
        {bn_min64 + bn_min64 - 2, {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x81}},
    };
    // clang-format on
}
