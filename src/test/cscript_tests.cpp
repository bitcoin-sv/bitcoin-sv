...
BOOST_AUTO_TEST_CASE(GetSigOpCount_p2sh)
{
    ...
    vector<test_data_type> test_data {
        { {45, MULTISIG_LOCKING_2}, false, 2, false }, 
        { {45, MULTISIG_LOCKING_2}, true, 0, false }, 
        
        { {OP_PUSHDATA1, 87, MULTISIG_LOCKING_4}, false, 4, false }, 
        { {OP_PUSHDATA1, 87, MULTISIG_LOCKING_4}, true, 0, false }, 
        
        { {OP_PUSHDATA1, 171, MULTISIG_LOCKING_8}, false, 8, false }, 
        { {OP_PUSHDATA1, 171, MULTISIG_LOCKING_8}, true, 0, false }, 
        
        { {OP_PUSHDATA2, 0x53, 0x1, MULTISIG_LOCKING_16}, false, 16, false }, 
        { {OP_PUSHDATA2, 0x53, 0x1, MULTISIG_LOCKING_16}, true, 0, false }, 
       
        // Note: MAX_PUBKEYS_PER_MULTISIG_BEFORE_GENESIS = 20
        { {OP_PUSHDATA2, 0xa8, 0x1, MULTISIG_LOCKING_20}, false, 20, false }, 
        { {OP_PUSHDATA2, 0xa8, 0x1, MULTISIG_LOCKING_20}, true, 0, false }, 
        
        { {OP_PUSHDATA2, 0xbd, 0x1, MULTISIG_LOCKING_21}, false, 20, false }, 
        { {OP_PUSHDATA2, 0xbd, 0x1, MULTISIG_LOCKING_21}, true, 0, false }, 

        { {OP_PUSHDATA2, 0xa4, 0x2, MULTISIG_LOCKING_32}, false, 20, false }, 
        { {OP_PUSHDATA2, 0xa4, 0x2, MULTISIG_LOCKING_32}, true, 0, false }, 
 
        { {48, MULTISIG_2_IF_LOCKING}, false, 3, false }, 
        { {48, MULTISIG_2_IF_LOCKING}, true, 0, false }, 
    };
