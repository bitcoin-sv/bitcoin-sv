...
BOOST_AUTO_TEST_CASE(compare)
{
    ...
    BOOST_CHECK_LT(b3, b4);
    BOOST_CHECK_LT(b4, b5);
    BOOST_CHECK_LT(b5, b6);
    BOOST_CHECK_LT(b6, b7);
    BOOST_CHECK_LT(b7, b8);
    BOOST_CHECK_LT(b8, b9);
    BOOST_CHECK_LT(b9, b10);
    BOOST_CHECK_LT(b10, b11);
    BOOST_CHECK_LT(b11, b12);
    BOOST_CHECK_LT(b12, b13);
    BOOST_CHECK_LT(b13, b14);
    BOOST_CHECK_LT(b14, b15);
    BOOST_CHECK_LT(b15, b16);
    
    BOOST_CHECK_GT(b16, b15);
    BOOST_CHECK_GT(b15, b14);
    BOOST_CHECK_GT(b14, b13);
    BOOST_CHECK_GT(b13, b12);
    BOOST_CHECK_GT(b12, b11);
    BOOST_CHECK_GT(b11, b10);
    BOOST_CHECK_GT(b10, b9);
    BOOST_CHECK_GT(b9, b8);
    BOOST_CHECK_GT(b8, b7);
    BOOST_CHECK_GT(b7, b6);
    BOOST_CHECK_GT(b6, b5);
    BOOST_CHECK_GT(b5, b4);
    BOOST_CHECK_GT(b4, b3);
    BOOST_CHECK_GT(b3, b2);
    BOOST_CHECK_GT(b2, b1);
    
    BOOST_CHECK_EQUAL(b1, b1);
    BOOST_CHECK_EQUAL(b2, b2);
    BOOST_CHECK_EQUAL(b3, b3);
    BOOST_CHECK_EQUAL(b4, b4);
    BOOST_CHECK_EQUAL(b5, b5);
    BOOST_CHECK_EQUAL(b6, b6);
    BOOST_CHECK_EQUAL(b7, b7);
    BOOST_CHECK_EQUAL(b8, b8);
    BOOST_CHECK_EQUAL(b9, b9);
    BOOST_CHECK_EQUAL(b10, b10);
    BOOST_CHECK_EQUAL(b11, b11);
    BOOST_CHECK_EQUAL(b12, b12);
    BOOST_CHECK_EQUAL(b13, b13);
    BOOST_CHECK_EQUAL(b14, b14);
    BOOST_CHECK_EQUAL(b15, b15);
    BOOST_CHECK_EQUAL(b16, b16);
}
