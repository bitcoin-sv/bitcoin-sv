...
static std::map<std::string, uint32_t> mapFlagNames = {
    ...
    {"LOW_S_WITH_FORKID", SCRIPT_VERIFY_LOW_S_WITH_FORKID},
    {"CLEANSTACK_WITH_FORKID", SCRIPT_VERIFY_CLEANSTACK_WITH_FORKID},
    {"MINIMALDATA_WITH_FORKID", SCRIPT_VERIFY_MINIMALDATA_WITH_FORKID},
    {"SIGPUSHONLY_WITH_FORKID", SCRIPT_VERIFY_SIGPUSHONLY_WITH_FORKID},
};
